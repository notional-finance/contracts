export const ErrorCodes = {
    ...
    RESERVE_ACCOUNT_HAS_INSUFFICIENT_BALANCE: '37',
    INSUFFICIENT_FREE_COLLATERAL_FOR_SETTLER: '38',
    INSUFFICIENT_FREE_COLLATERAL_FOR_LIQUIDATOR: '39',
    CANNOT_LIQUIDATE_SELF: '40',
    CANNOT_GET_PRICE_FOR_MATURITY: '41',
    CANNOT_SETTLE_PRICE_DISCREPENCY: '42',
    OVER_MAX_FUTURE_CASH: '43',
    OVER_MAX_UINT128_AMOUNT: '44',
    PAST_MAX_MATURITY: '45',
    TRADE_MATURITY_ALREADY_PASSED: '46',
    CANNOT_SETTLE_TO_WORSE_FREE_COLLATERAL: '47',
    CANNOT_LIQUIDATE_TO_WORSE_FREE_COLLATERAL: '48',
