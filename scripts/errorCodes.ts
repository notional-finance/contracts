export const ErrorCodes = {
    ...
    INSUFFICIENT_FREE_COLLATERAL_FOR_SETTLER: '40',
    INSUFFICIENT_FREE_COLLATERAL_FOR_LIQUIDATOR: '41',
    CANNOT_LIQUIDATE_SELF: '42',
    CANNOT_GET_PRICE_FOR_MATURITY: '43',
    CANNOT_SETTLE_PRICE_DISCREPENCY: '44',
    OVER_MAX_FUTURE_CASH: '45',
