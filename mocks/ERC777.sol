...
contract ERC777 is Context, IERC777, IERC20, Ownable {
    ...
    constructor(address registry) public {
        ...
        // On other chains, this registry is always at: 0x1820a4B7618BdE71Dce8cdc73aAB6C95905faD24
        ERC1820_REGISTRY = IERC1820Registry(registry);

        _defaultOperatorsArray = [owner()];
        ...
        _mint(owner(), owner(), 100000000000000, "", "");
    }
    ...
    */
    ...
    function _callTokensReceived(
        ...
        if (implementer != address(0)) {
            ...
            require(!to.isContract(), "ERC777: no implementer for ERC777TokensRecipient");
        }
    }
}
