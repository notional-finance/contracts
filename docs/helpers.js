module.exports = {
  isUserMethod: (visibility, natspec) => { 
    if (visibility === "public" || visibility === "external") {
      if (natspec.devdoc !== undefined && 
          (natspec.devdoc.trim() === "skip" || natspec.devdoc.trim() === "governance")) {
        return false;
      }
  ...
  isGovernance: (visibility, natspec) => {
    if ((visibility === "public" || visibility === "external")
        && (natspec.devdoc !== undefined && natspec.devdoc.trim() == "governance")) {
      return true;
    }
    ...
    if (Array.isArray(ownFunctions)) {
      for (let func of ownFunctions) {
        ...
        if ((func.visibility === "public" || func.visibility === "external")
            && (func.natspec.devdoc !== undefined && func.natspec.devdoc.trim() == "governance")) {
          return true;
        }
      }
    }
